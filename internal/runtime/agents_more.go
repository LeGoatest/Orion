...
func (a *AnalysisAgent) Capabilities() []string {
...
func (a *CodeIndexerAgent) Name() string {
	return "CodeIndexerAgent"
}

func (a *CodeIndexerAgent) Capabilities() []string {
	return []string{"INDEX_CODE"}
}
...
func (a *MemoryGardenerAgent) Name() string {
	return "MemoryGardenerAgent"
}

func (a *MemoryGardenerAgent) Capabilities() []string {
	return []string{"GARDEN_MEMORY"}
}
...
func (a *PatternDetectorAgent) Name() string {
	return "PatternDetectorAgent"
}

func (a *PatternDetectorAgent) Capabilities() []string {
	return []string{"DETECT_PATTERNS"}
}
