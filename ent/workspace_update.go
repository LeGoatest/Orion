...
func (_u *WorkspaceUpdate) SetPath(v string) *WorkspaceUpdate {
	_u.mutation.SetPath(v)
	return _u
}

// SetNillablePath sets the "path" field if the given value is not nil.
func (_u *WorkspaceUpdate) SetNillablePath(v *string) *WorkspaceUpdate {
	if v != nil {
		_u.SetPath(*v)
	}
	return _u
...
func (_u *WorkspaceUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.Path(); ok {
		_spec.SetField(workspace.FieldPath, field.TypeString, value)
	}
...
// SetPath sets the "path" field.
func (_u *WorkspaceUpdateOne) SetPath(v string) *WorkspaceUpdateOne {
	_u.mutation.SetPath(v)
	return _u
}

// SetNillablePath sets the "path" field if the given value is not nil.
func (_u *WorkspaceUpdateOne) SetNillablePath(v *string) *WorkspaceUpdateOne {
	if v != nil {
		_u.SetPath(*v)
	}
	return _u
